...
namespace MessageTypes
{
    public class OptionDocumentCollectionMessageReceiver : IMessageReceiver
    {
        ...
        public DocumentCollection GetDocumentCollectionText()
        {
            ...
            {
                new PlainText { Text = "Text 1" },
                new PlainText { Text = "Text 2" },
                new PlainText { Text = "Text 3" },
            };

            var document = new DocumentCollection { ItemType = "text/plain", Items = documents };
            return document;
        }
            ...
            DocumentContainer[] documents = new DocumentContainer[]
            {
                ...
                new DocumentContainer
                {
                    Value = new Select
                    {
                        ...
                        {
                            new SelectOption { Order = 1, Text = "See our stock" },
                            new SelectOption { Order = 2, Text = "Follow an order" },
                        },
                    },
                },
            };
                ...
                new DocumentSelect
                {
                    ...
                    Options = new DocumentSelectOption[]
                    {
                        ...
                        new DocumentSelectOption
                        {
                            Label = new DocumentContainer
                            {
                                Value = new PlainText { Text = "Text 1" },
                            },
                ...
                new DocumentSelect
                {
                    ...
                    Options = new DocumentSelectOption[]
                    {
                        new DocumentSelectOption
                        {
                            Label = new DocumentContainer
                            {
                                Value = new WebLink
                                {
                                    ...
                                    Text = "Weblink",
                                    Uri = new Uri(
                                        "https://pt.dreamstime.com/foto-de-stock-brinquedo-pl%C3%A1stico-amarelo-do-pato-image44982058"
                                    ),
                                },
                            },
                        },
                        new DocumentSelectOption
                        {
                            Label = new DocumentContainer
                            {
                                Value = new PlainText { Text = "Second text" },
                            },
                            Value = new DocumentContainer { Value = jsonDocuments2 },
                        },
                        new DocumentSelectOption
                        {
                            Label = new DocumentContainer
                            {
                                Value = new PlainText { Text = "More one text" },
                            },
                            Value = new DocumentContainer { Value = jsonDocuments3 },
                        },
                    },
                },
            };
