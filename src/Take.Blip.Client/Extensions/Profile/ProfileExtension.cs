...
namespace Take.Blip.Client.Extensions.Profile
{
    public class ProfileExtension : ExtensionBase, IProfileExtension
    {
        ...
        public ProfileExtension(ISender sender)
            : base(sender) { }
        ...
        public Task<Document> SetGetStartedAsync(
            Document getStarted,
        ...
        public Task SetPersistentMenuAsync(
        ...
        {
            if (
                responseCommand.Method == CommandMethod.Get
