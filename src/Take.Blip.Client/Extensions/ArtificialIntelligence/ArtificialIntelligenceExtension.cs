...
namespace Take.Blip.Client.Extensions.ArtificialIntelligence
{
    ...
    {
        private static readonly Node ArtificialIntelligenceAddress = Node.Parse(
            $"postmaster@ai.{Constants.DEFAULT_DOMAIN}"
        );
        ...
        public Task<ContentAssistant> GetContentAssistantAsync(
            Document document,
            CancellationToken cancellationToken = default
        ) =>
            ProcessCommandAsync<ContentAssistant>(
                CreateSetCommandRequest(
                    document,
                    UriTemplates.ASSISTANT_ANALYSIS,
                    ArtificialIntelligenceAddress
                ),
                cancellationToken
            );
        ...
        public Task<Answer> GetAnswerAsync(
            string intentionId,
            string answerId,
            CancellationToken cancellationToken = default(CancellationToken)
        ) =>
        ...
        public Task<DocumentCollection> GetAnswersAsync(
            string intentionId,
            int skip = 0,
            int take = 100,
            bool ascending = true,
        ...
        public Task<DocumentCollection> GetEntitiesAsync(
            int skip = 0,
            int take = 100,
            bool ascending = true,
            CancellationToken cancellationToken = default(CancellationToken)
        ...
        public Task<Entity> GetEntityAsync(
            string id,
            CancellationToken cancellationToken = default(CancellationToken)
        ) =>
        ...
        public Task<Intention> GetIntentionAsync(
            string id,
            CancellationToken cancellationToken = default(CancellationToken)
        ) =>
        ...
        public Task<DocumentCollection> GetIntentionsAsync(
            int skip = 0,
            int take = 100,
            bool ascending = true,
            CancellationToken cancellationToken = default(CancellationToken)
        ...
        public Task<DocumentCollection> GetModelsAsync(
            int skip = 0,
            int take = 100,
            bool ascending = true,
            CancellationToken cancellationToken = default(CancellationToken)
        ...
        public Task<Question> GetQuestionAsync(
            string intentionId,
            string questionId,
            CancellationToken cancellationToken = default(CancellationToken)
        ) =>
        ...
        public Task<DocumentCollection> GetQuestionsAsync(
            string intentionId,
            int skip = 0,
            int take = 100,
            bool ascending = true,
        ...
        public Task<Entity> SetEntityAsync(
            Entity entity,
            CancellationToken cancellationToken = default(CancellationToken)
        ) =>
            ProcessCommandAsync<Entity>(
        ...
        public Task<Intention> SetIntentionAsync(
            Intention intention,
            CancellationToken cancellationToken = default(CancellationToken)
        ) =>
            ProcessCommandAsync<Intention>(
        ...
        private static string GetQueryString(int skip, int take, bool ascending) =>
            $"$skip={skip.ToString()}&$take={take.ToString()}&$ascending={ascending.ToString()}";
    }
}
