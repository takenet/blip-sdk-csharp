...
namespace Take.Blip.Builder.UnitTests.Utils
{
    public class SensisitveInfoReplacerTests : FlowManagerTestsBase
    {
        ...
        private const string SETTINGS_HEADER_WITHOUT_VALUES =
            @"{""headers"":{},""method"":""GET"",""uri"":""https://enz557qv71nso.x.pipedream.net""}";
        ...
        {
            //Arrange
            var contentToSubstitute =
                @"{""headers"":{""BotKey"":""Key AAAAAAAAAAAAA"",""OtherHeader"":""OtherValue"",""Content-Type"":""application/json""},""method"":""GET"",""uri"":""https://enz557qv71nso.x.pipedream.net"",""secretUrlBlip"":false}";
            var expectedContent =
                @"{""headers"":{""BotKey"":""***"",""OtherHeader"":""***"",""Content-Type"":""***""},""method"":""GET"",""secretUrlBlip"":false,""uri"":""https://enz557qv71nso.x.pipedream.net""}";
