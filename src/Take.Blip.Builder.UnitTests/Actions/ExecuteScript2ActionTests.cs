...
namespace Take.Blip.Builder.UnitTests.Actions
{
    ...
    {
        private static ExecuteScriptV2Action GetTarget(
        ...
        )
        {
            ...
            configuration.ExecuteScriptV2Timeout =
                timeout == default ? TimeSpan.FromMilliseconds(300) : timeout;
        ...
        public async Task ExecuteWithSingleStatementScriptShouldSucceed()
        {
            ...
            await Context
                .Received(0)
                .DeleteVariableAsync(variableName, Arg.Any<CancellationToken>());
        }
...
",
        ...
        public async Task ExecuteWithCustomTimeZoneDateStringAndTimeStringWithAmericaShouldWork()
        {
            ...
            await Context
                ...
                .SetVariableAsync(
                    "test",
                    "Fri Jan 01 2021 00:00:10 GMT-03:00",
                    Arg.Any<CancellationToken>()
                );
        }
...
function run() {
    ...
    return (parsedDate.toDateString() + ' ' + parsedDate.toTimeString()) == parsedDate.toString();
            ...
            await Context
                .Received(1)
                .SetVariableAsync("test", "true", Arg.Any<CancellationToken>());
        }
...
function run(number1, number2) {
    return parseInt(number1) + parseInt(number2);
            ...
            await Context
                .Received(1)
                .SetVariableAsync("result", "350", Arg.Any<CancellationToken>());
        }
...
function run(number1, number2, number3) {
    return parseInt(number1) + parseInt(number2) + (number3 || 150);
            ...
            await Context
                .Received(1)
                .SetVariableAsync("result", "500", Arg.Any<CancellationToken>());
        }
...
",
        ...
        public async Task ExecuteDateToStringWithCustomTimeZoneShouldWork()
        {
            ...
            await Context
                ...
                .SetVariableAsync(
                    "test",
                    "2021-01-01T08:00:00.0000000+08:00",
                    Arg.Any<CancellationToken>()
                );
        }
...
function run (input) {
    try {
        ...
        return {
            ...
            var target = GetTarget(timeout: TimeSpan.FromMilliseconds(5000));
