    ...
    public class InputVariableProviderTests : CancellationTokenTestsBase
    {
        public InputVariableProviderTests()
        {
            ...
            ArtificialIntelligenceExtension
                .AnalyzeAsync(
                    Arg.Is<AnalysisRequest>(r => r.Text == NoIntentInputText),
                    Arg.Any<CancellationToken>()
                )
                .Returns(NoIntentResponse);
            ArtificialIntelligenceExtension
                .AnalyzeAsync(
                    Arg.Is<AnalysisRequest>(r => r.Text == IntentInputText),
                    Arg.Any<CancellationToken>()
                )
                .Returns(IntentResponse);
            ArtificialIntelligenceExtension
                .AnalyzeAsync(
                    Arg.Is<AnalysisRequest>(r => r.Text == IntentAndEntityText),
                    Arg.Any<CancellationToken>()
                )
                .Returns(IntentsAndEntitiesResponse);
            ArtificialIntelligenceExtension
                .AnalyzeAsync(
                    Arg.Is<AnalysisRequest>(r => r.Text == MultipleIntentsAndEntitiesText),
                    Arg.Any<CancellationToken>()
                )
                .Returns(MultipleIntentsAndEntitiesResponse);
            ArtificialIntelligenceExtension
                .GetContentResultAsync(
                    Arg.Is<ContentCombination>(cc => cc.Intent == default),
                    Arg.Any<CancellationToken>()
                )
                .Returns(NoContentResult);
            ArtificialIntelligenceExtension
                .GetContentResultAsync(
                    Arg.Is<ContentCombination>(cc => cc.Intent == LearnIntent.Id),
                    Arg.Any<CancellationToken>()
                )
                .Returns(ContentResultWithIntent);
            ArtificialIntelligenceExtension
                .GetContentResultAsync(
                    Arg.Is<ContentCombination>(cc =>
                        cc.Intent == IntentAndEntityCombination.Intent
                        && cc.Entities.SequenceEqual(IntentAndEntityCombination.Entities)
                    ),
                    Arg.Any<CancellationToken>()
                )
            ...
            ArtificialIntelligenceExtension
                .GetContentResultAsync(
                    Arg.Is<ContentCombination>(cc =>
                        cc.Intent == IntentAndMultipleEntitiesCombination.Intent
                        && cc.Entities.SequenceEqual(IntentAndMultipleEntitiesCombination.Entities)
                    ),
                    Arg.Any<CancellationToken>()
                )
        ...
        public static string IntentAndMultipleEntitiesContentResultText =
            "I can fix all your vehicles";
        ...
        public static ContentCombination IntentAndEntityCombination = new ContentCombination
        {
            ...
            Entities = new string[] { MussarelaPizzaEntity.Value },
        };

        public static ContentCombination IntentAndMultipleEntitiesCombination =
            new ContentCombination
            {
                Intent = OwnershipIntent.Id,
                Entities = new string[] { PlaneVehicleEntity.Value, CarVehicleEntity.Value },
            };
        ...
        {
            Id = MessagId,
            Content = new PlainText { Text = NoIntentInputText },
        };

        public Message IntentMessage = new Message()
        {
            Id = MessagId,
            Content = new PlainText { Text = IntentInputText },
        };

        public Message IntentAndEntityMessage = new Message()
        {
            Id = MessagId,
            Content = new PlainText { Text = IntentAndEntityText },
        };

        public Message MultipleIntentsAndEntitiesMessage = new Message()
        {
            Id = MessagId,
            Content = new PlainText { Text = MultipleIntentsAndEntitiesText },
        };

        public Message ValidContentResultMessage = new Message()
        {
            Id = MessagId,
            Content = new PlainText { Text = IntentAndEntityContentResultText },
        };
        ...
        {
            Intentions = new IntentionResponse[] { LearnIntent },
        };

        public AnalysisResponse IntentsAndEntitiesResponse = new AnalysisResponse
        {
            Intentions = new IntentionResponse[] { BuyPizzaIntent },
            Entities = new EntityResponse[] { MussarelaPizzaEntity },
        };

        public AnalysisResponse MultipleIntentsAndEntitiesResponse = new AnalysisResponse
        {
            Intentions = new IntentionResponse[] { OwnershipIntent, DriveIntent },
            Entities = new EntityResponse[] { PlaneVehicleEntity, CarVehicleEntity },
        };
        ...
        public ContentResult ContentResultWithIntent = new ContentResult
        {
            ...
            {
                Id = MessagId,
                Content = new PlainText { Text = IntentContentResultText },
            },
            Combinations = new ContentCombination[] { IntentCombination },
        };
        ...
        public ContentResult ContentResultWithIntentAndEntity = new ContentResult
        {
            ...
            Combinations = new ContentCombination[] { IntentAndEntityCombination },
        };
        ...
        public ContentResult ContentResultWithIntentAndMultipleEntities = new ContentResult
        {
            ...
            {
                Id = MessagId,
                Content = new PlainText { Text = IntentAndMultipleEntitiesContentResultText },
            },
            Combinations = new ContentCombination[] { IntentAndMultipleEntitiesCombination },
        };
        ...
        public async Task CheckIfNoIntentVariableIsValid()
        {
            ...
            Context = new ExtensionContext(
                ...
                LazyInput,
                new Flow(),
                new List<InputVariableProvider>(),
                null
            );
        ...
        public async Task CheckIfMultipleIntentsAndEntitiesVariableIsValid()
        {
            // Arrange
            LazyInput = new LazyInput(
                MultipleIntentsAndEntitiesMessage,
                UserIdentiy,
                BuilderConfiguration,
                DocumentSerializer,
                null,
        ...
        public async Task CheckIfAssistantResultWithoutCombinationsIsValid()
        {
            ...
            // Act
            var actualId = await target.GetVariableAsync(
                "contentAssistant.id",
                Context,
                CancellationToken
            );
        ...
        public async Task CheckIfAssistantResultWithIntentCombinationIsValid()
        {
            ...
            // Act
            var actualValue = await target.GetVariableAsync(
                "contentAssistant.result",
                Context,
                CancellationToken
            );
            var actualId = await target.GetVariableAsync(
        ...
        public async Task CheckIfAssistantResultWithIntentAndMultipleEntitiesCombinationIsValid()
        {
            ...
            actualValue.ShouldBe(
                ContentResultWithIntentAndMultipleEntities.Result.Content.ToString()
            );
