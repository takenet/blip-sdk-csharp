...
{
    public class FlowManagerSubflowTests : FlowManagerTestsBase, IDisposable
    {
        [Fact]
        public async Task FlowWithoutConditionsShouldChangeStateAndSendMessage()
        {
            ...
            // Act
            await target.ProcessInputAsync(Message, flow, CancellationToken, flow);
        ...
        public async Task FlowWithInputContextConditionsSatisfiedShouldKeepStateAndWaitNextInput()
        {
            ...
            // Act
            await target.ProcessInputAsync(inputOk, flow, CancellationToken, flow);
        ...
        public async Task FlowWithInputContextConditionsNotSatisfiedShouldChangeStateAndSendMessage()
        {
            ...
            // Act
            await target.ProcessInputAsync(inputNOk, flow, CancellationToken, flow);
        ...
        public async Task FlowWithConditionsAndMultipleInputsShouldChangeStatesAndSendMessages()
        {
            ...
            // Act
            await target.ProcessInputAsync(input1, flow, CancellationToken, flow);
            await target.ProcessInputAsync(input2, flow, CancellationToken, flow);
        ...
        public async Task TimeoutOnActionShouldOverrideDefaultConfiguration()
        {
            ...
            // Act
            var exception = await target.ProcessInputAsync(Message, flow, CancellationToken, flow).ShouldThrowAsync<ActionProcessingException>();
        ...
        public async Task ActionWithInvalidSettingShouldBreakProcessing()
        {
            ...
            // Act
            await target
                .ProcessInputAsync(Message, flow, CancellationToken, flow)
