...
namespace Take.Blip.Client.Console
{
    ...
    public class Options
    {
        ...
        [Value(
            0,
            HelpText = "The path of the application host JSON file.",
            Default = Bootstrapper.DefaultApplicationFileName
        )]
        public string ApplicationJsonPath { get; set; }

        [Option(
            START_TIMEOUT_FLAG,
            HelpText = "The timeout in seconds to wait for the startup of the application.",
            Default = 30
        )]
        ...
        [Option(
            RUN_AS_SERVICE_FLAG,
            HelpText = "Runs the application as a service (only on Windows)",
            Default = false
        )]
        ...
        [Option(
            INSTALL_FLAG,
            HelpText = "Install the application as service (only on Windows)",
            Default = false
        )]
        ...
        [Option(
            UNINSTALL_FLAG,
            HelpText = "Uninstall a previously installed service (only on Windows)",
            Default = false
        )]
        ...
        [Option(
            SERVICE_NAME_FLAG,
            HelpText = "The service name for installation or uninstallation"
        )]
        ...
        [Option(
            ...
            HelpText = "The app is running in non-interactive mode, i.e., the app doesn't wait for a key press to stop itself",
            Default = false
        )]
