        ...
        )
        {
            ...
            if (outputs != null)
            {
                ...
                foreach (var output in outputs.OrderBy(o => o.Order))
                {
                        ...
                        )
                        {
                            ...
                            if (state == null)
                            {
                                ...
                                throw new InvalidOperationException(
                                    $"Failed to process output condition, because the output context variable '{output.StateId}' is undefined or does not exist in the context."
                                );
                            }
                    ...
                    {
                        _blipMonitoringLogger.UserInput(
                            new LogInput
                            {
                                Data = new JObject
                                {
                                    ...
                                    ["outputConditions"] =
                                        output.Conditions != null
                                            ? JToken.FromObject(output.Conditions)
                                            : null,
