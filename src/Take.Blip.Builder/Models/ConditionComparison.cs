...
namespace Take.Blip.Builder.Models
{
    ...
    public static class ConditionComparisonExtensions
    {
        ...
        public static Func<string, bool> ToUnaryDelegate(
            ...
            switch (conditionComparison)
            {
                ...
                case ConditionComparison.LessThanOrEquals:
                    throw new ArgumentException(
                        "The provided value is not an unary comparison",
                        nameof(conditionComparison)
                    );
        ...
        public static Func<string, string, bool> ToBinaryDelegate(
            this ConditionComparison conditionComparison
        )
        {
            switch (conditionComparison)
            {
                ...
                case ConditionComparison.Contains:
                    return (v1, v2) =>
                        v1 != null
                        && v2 != null
                        && v1.IndexOf(v2, StringComparison.OrdinalIgnoreCase) >= 0;
                ...
                case ConditionComparison.EndsWith:
                    return (v1, v2) =>
                        v1 != null
                        && v2 != null
                        && v1.EndsWith(v2, StringComparison.OrdinalIgnoreCase);

                case ConditionComparison.Matches:
                    return (v1, v2) =>
                        v1 != null
                        && v2 != null
                        && Regex.IsMatch(v1, v2, default, Constants.REGEX_TIMEOUT);
                ...
                case ConditionComparison.GreaterThan:
                    return (v1, v2) =>
                        decimal.TryParse(v1, out var n1)
                        && decimal.TryParse(v2, out var n2)
                        && n1 > n2;
                ...
                case ConditionComparison.NotExists:
                    throw new ArgumentException(
                        "The provided value is not a binary comparison",
                        nameof(conditionComparison)
                    );
